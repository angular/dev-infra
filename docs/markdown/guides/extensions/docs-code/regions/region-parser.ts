...
// Region parsing is done within this pipeline to allow for retrieving a subset of a file
// by extracting only the portion of the file between the provided regionblock comments.
 ...
 */
export const regionParser = (contents: string, fileType: FileType) => {
...
/** Remove last instance of the provided item from the array. */
