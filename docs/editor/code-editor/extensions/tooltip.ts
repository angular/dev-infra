...
function getHtmlFromDisplayParts(displayParts: typescript.SymbolDisplayPart[]): HTMLDivElement {
  const wrapper = document.createElement('div');
...
function getTagsHtml(tags: typescript.JSDocTagInfo[]): HTMLDivElement {
