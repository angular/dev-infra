...
describe('size tracking', () => {
  ...
  it('should keep track of unmapped bytes in the file', async () => {
    ...
    const tracker = new SizeTracker(inputPath, mapPath);
  ...
  it('should properly combine mapped characters from same source', async () => {
    generator.addMapping({
  ...
  it('should keep track of summed-up byte sizes for directories', async () => {
    generator.addMapping({
      generated: {line: 1, column: 0},
      original: {line: 1, column: 0},
